					...
					<div class="col-md-6">
						<div class="product-body">
							...
							<div class="product-options">
								...
								<ul class="color-option">
									...
									<li class="active"><a href="#"
										style="background-color: #475984;"></a></li>
							...
							<div class="product-btns">
								<div class="qty-input">
									<span class="text-uppercase">QTY: </span> <input class="input"
										type="number">
								</div>
											...
											<div class="product-reviews">
												<div class="single-review">
													<div class="review-heading">
														<div>
															<a href="#"><i class="fa fa-user-o"></i> John</a>
														</div>
														<div>
															<a href="#"><i class="fa fa-clock-o"></i> 27 DEC 2017
																/ 8:0 PM</a>
														</div>
